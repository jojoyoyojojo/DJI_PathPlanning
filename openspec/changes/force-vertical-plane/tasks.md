...
## Task 1: Add FORCE_VERTICAL_PLANE configuration constant
...
## Task 2: Implement vertical plane projection in FacadeTransformer
...
## Task 3: Add GUI checkbox for Force Vertical Plane
...
- **Verification**: Visual inspection confirms expected behavior
